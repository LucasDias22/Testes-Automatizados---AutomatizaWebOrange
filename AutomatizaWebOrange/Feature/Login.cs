...
namespace AutomatizaWebOrange.Feature
{
    ...
    public class Login : Inicializacao
    {
        ...
        public void ValidarTrocaDeSenha()
        {
            WriteLine("Dado: Ao acessar o site https://opensource-demo.orangehrmlive.com/web/index.php/auth/login");
            WriteLine("E: Preencher o campo @Username com valor válido");
            WriteLine("E: Não saber o @Password previamente cadastrado");
            ...
            WriteLine("E: Deverá preencher o @Username previamente cadastrado");
            WriteLine("E: Clicar no botão [Reset Password]");
        ...
        [TestMethod]
        [TestCategory("07")]
        public void ValidarExibicaoDaTelaPIM()
        {
            ...
            WriteLine("Quando: Exibir a tela 'PIM'");
            WriteLine("Então: Será redirecionado ao link: 'https://opensource-demo.orangehrmlive.com/web/index.php/pim/viewEmployeeList'");

            LoginSteps.ValidarExibicaoDaTelaPIM("Admin", "admin123");
